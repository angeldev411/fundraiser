...
export const RECORDED_HOURS = `${ADMIN_BASE_URL}/hours`;
...
export const ADMIN_USER_DASHBOARD = 'user';
export const ADMIN_USER_PROFILE = `${ADMIN_USER_DASHBOARD}/profile`;
...
export const ADMIN_USER_PROFILE_URL = `${ADMIN_BASE_URL}/${ADMIN_USER_PROFILE}`;
